  ...
  return (
    <div className="w-full h-11 overflow-hidden relative bg-[#0E19C2]">
      <div className="flex items-center gap-[23px] h-full animate-[scroll_20s_linear_infinite] px-5 py-0">
        <div className="text-white text-[25px] font-extrabold whitespace-nowrap max-sm:text-xl">стратегия</div>
        <div className="text-white text-[25px] font-extrabold whitespace-nowrap max-sm:text-xl">управление</div>
