...
const enemies = [
  {
    ...
    description:
      "Ваш сейлз ненавидит вашего маркетолога. Ваш маркетолог презирает вашего продакта. Каждый лид, каждая задача, переходя из отдела в отдел, теряет энергию и смысл, закапывая доверие и деньги. Это не \"трудности роста\", а операционный долг.",
  },
  {
