...
const enemies = [
  {
    title: "ОПЕРАЦИОННЫЙ ДОЛГ НА СТЫКАХ",
    description:
      "Передача лида, контракта или задачи рвётся на границах команд. Решения застревают, появляются очереди и «камни в шестерёнках». Это и есть операционный долг: сотни человеко‑часов утекают вникуда, сжигая деньги и доверие.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Ты — самое узкое место. Перфекционизм и «нет времени» держат решения у тебя в личке. Бизнес растёт со скоростью твоих ответов. Нужна смена архитектуры и правил, чтобы команда сама тянула результат.",
  },
];
