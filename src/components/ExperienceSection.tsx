...
const enemies = [
  {
    title: "КОМАНДА Д'АРТАНЬЯНОВ",
    description:
      "Ваш сейлз ненавидит вашего маркетолога. Ваш маркетолог презирает вашего продакта. Каждый лид, каждая задача, переходя из отдела в отдел, теряет энергию и смысл. Это не \"трудности роста\", а операционный долг: сотни человеко‑часов утекают вникуда, сжигая деньги и доверие",
  },
  {
    title: "МЕТРИКИ ВМЕСТО РЕЗУЛЬТАТА",
    description:
      "Слова не сходятся с делами, а KPI не помогает в мотивации. Люди оптимизируют отчёты и дашборды, а не прибыль. Возникает Театр эффективности: все заняты, а ключевые метрики стоят на месте.",
  },
  {
